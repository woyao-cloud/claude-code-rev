...
const DEFAULT_PREFIX = `You are Yao Code, Anthropic's official CLI for Claude.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Yao Code, Anthropic's official CLI for Claude, running within the Yao Agent SDK.`
const AGENT_SDK_PREFIX = `You are a Yao agent, built on Anthropic's Yao Agent SDK.`
