export const BASE_CHROME_PROMPT = `# Yao in Chrome browser automation
...
/**
 * Minimal hint about Yao in Chrome skill availability. This is injected at startup when the extension is installed
