...
import { editFileInEditor, editPromptInEditor } from '../../../prompt/tools/editor.js';
      ...
      <PermissionDialog color="planMode" title="Ready to code?" innerPaddingX={0} workerBadge={workerBadge}>
        ...
        overflow="hidden">
          ...
          <Box flexDirection="column" paddingX={1}>
            ...
            {!useStickyFooter && <>
                <Text dimColor>
                  Yao has written up a plan and is ready to execute. Would
                  you like to proceed?
                </Text>
                <Box marginTop={1}>
...
export function buildPlanApprovalOptions({
  ...
  if (showUltraplan) {
    options.push({
      label: 'No, refine with Ultraplan on Yao Code on the web',
      value: 'ultraplan'
    });
  }
  options.push({
    ...
    value: 'no',
    placeholder: 'Tell Yao what to change',
