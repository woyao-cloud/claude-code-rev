...
# Yao Code Documentation Map

This is a comprehensive map of all Yao Code documentation pages with their headings, designed for easy navigation by LLMs.
...
* Get started
* What you can do
* Use Yao Code everywhere
* Next steps

### [quickstart](https://code.claude.com/docs/en/quickstart.md)

* Before you begin
* Step 1: Install Yao Code
* Step 2: Log in to your account
* Step 3: Start your first session
* Step 4: Ask your first question
* Step 5: Make your first code change
* Step 6: Use Git with Yao Code
...
* Stay safe with checkpoints and permissions
  ...
  * Control what Yao can do
* Work effectively with Yao Code
  * Ask Yao Code for help
  * It's a conversation
    * Interrupt and steer
  * Be specific upfront
  * Give Yao something to verify against
...
* Troubleshoot memory issues
  * Yao isn't following my CLAUDE.md
...
* Run parallel Yao Code sessions with Git worktrees
  * Subagent worktrees
  * Worktree cleanup
  * Copy gitignored files to worktrees
  * Manage worktrees manually
  * Non-git version control
* Get notified when Yao needs your attention
* Use Yao as a unix-style utility
  * Add Yao to your verification process
  * Pipe in, pipe out
  * Control output format
* Run Yao on a schedule
* Ask Yao about its capabilities
  * Example questions
* Next steps

### [best-practices](https://code.claude.com/docs/en/best-practices.md)

* Give Yao a way to verify its work
...
### Platforms and integrations > Yao Code on the web

#### [claude-code-on-the-web](https://code.claude.com/docs/en/claude-code-on-the-web.md)

* What is Yao Code on the web?
* Who can use Yao Code on the web?
* Getting started
  * From the browser
  * From the terminal
* How it works
...
* Auto-fix pull requests
  * How Yao responds to PR activity
...
### Platforms and integrations > Yao Code on desktop
...
* Why use Yao Code GitHub Actions?
* What can Yao do?
  * Yao Code Action
* Setup
* Quick setup
...
* Using with AWS Bedrock & Google Vertex AI
  * Prerequisites
    ...
    * For AWS Bedrock:
* Troubleshooting
  * Yao not responding to @claude commands
...
* Remote Control vs Yao Code on the web
* Limitations
* Troubleshooting
...
* How Yao works on your screen
  * One session at a time
  * Apps are hidden while Yao works
  * Stop at any time
...
* Troubleshooting
  * "Computer use is in use by another Yao session"
...
* Configure settings
  * Extension settings
* VS Code extension vs. Yao Code CLI
  * Rewind with checkpoints
  * Run CLI in VS Code
...
* Import MCP servers from Yao Desktop
* Use MCP servers from Claude.ai
* Use Yao Code as an MCP server
...
* Official Anthropic marketplace
  * Code intelligence
    * What Yao gains from code intelligence plugins
...
* What you can automate
  * Get notified when Yao needs input
...
* Common installation issues
  ...
  * Windows: Yao Desktop overrides `claude` CLI command
...
* Set up team authentication
  * Yao for Teams or Enterprise
  * Yao Console authentication
...
* Data policies
  ...
  * Data retention
* Data access
* Local Yao Code: Data flow and dependencies
...
* Security and privacy
* Monitor Yao Code on Amazon Bedrock
...
* Understanding changes in Yao Code behavior
